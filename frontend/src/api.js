...
export const getB2CMonthly     = (year)                => api.get('/api/b2c/monthly',  { params: { year, ...(maxMonth ? { max_month: maxMonth } : {}) } }).then(r => r.data)
...
export const getB2BAgencies    = (year, maxMonth) => api.get('/api/b2b/partners', { params: { year } }).then(r => r.data)
